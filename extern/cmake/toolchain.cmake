...
if (PLATFORM_DESKTOP)
    ...
    if (_moonlight_use_system_desktop_packages)
        set(USE_SYSTEM_SDL2 ON CACHE BOOL "Use SDL2 provided by the system package manager" FORCE)
...
elseif (PLATFORM_SWITCH)
    ...
    if (NOT DEFINED DEVKITPRO AND NOT DEFINED ENV{DEVKITPRO})
        message(FATAL_ERROR "Please set DEVKITPRO. export DEVKITPRO=<path to>/devkitpro")
    endif ()
    if (NOT DEFINED DEVKITPRO)
        if (DEFINED ENV{DEVKITPRO})
            set(DEVKITPRO "$ENV{DEVKITPRO}" CACHE PATH "DEVKITPRO")
        endif()
    endif ()
    set(__SWITCH__ ON)
